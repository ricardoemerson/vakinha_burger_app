...
const darkGreyColor = Color(0xFF323F4B);
const lightGreyColor = Color(0xFFDADADA);

const dividerColor = Color(0xFFAAAEB2);
const iconColor = Color(0xFF414A52);

const secondaryColor = Color(0xFFEFB555);
const successColor = Color(0xFF44AB61);
const errorColor = Color(0xFFE83F5B);
const errorColorLight = Color(0xFFEF798C);
